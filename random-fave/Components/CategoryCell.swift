...
class CategoryCell: UICollectionViewCell {
    ...
    var category: Category? {
        didSet {
            ...
            imageView.image = UIImage(named: unwrappedCategory.name)
            
            let attributedText = NSMutableAttributedString(string: unwrappedCategory.name, attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 30)])
    ...
    private func setupLayout() {
        ...
        imageView.centerYAnchor.constraint(equalTo: topImageContainerView.centerYAnchor, constant: 120).isActive = true
